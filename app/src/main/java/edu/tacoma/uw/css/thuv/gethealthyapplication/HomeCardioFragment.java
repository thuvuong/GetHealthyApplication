...
/**
 * The home cardio fragment where the user has a list of exercises
 * to choose from.
 *
 * @author Team 11
 * @version May 10, 2018
 */
public class HomeCardioFragment extends Fragment {

    /**
     * The listener for this fragment to notify the activity of changes.
     */
    private OnFragmentInteractionListener mListener;

    /** Required empty public constructor.*/
    public HomeCardioFragment() {
     ...
     * @return A new instance of fragment HomeCardioFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static HomeCardioFragment newInstance(String param1, String param2) {
        HomeCardioFragment fragment = new HomeCardioFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_home_cardio, container, false);
    }
